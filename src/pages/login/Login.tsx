...
const Login: React.FC = () => {
    ...
    const { user, setLoading, login } = AuthState();
    ...
    //navigate user to the expected page
    ...
    return (
        <section className=" login_section lg:py-20 py-14 bg-gray-100 ">
            <div className='container mx-auto lg:max-w-7xl md:px-10 px-6'>
                ...
                <div className=' form_wrapper bg-white px-10 py-10 w-full mx-auto lg:max-w-lg rounded'>
                    ...
                    <form onSubmit={handleSubmit(handleLogin)} className="flex flex-col gap-4 text-left">
                        ...
                        <button className='bg-blue-500 text-white hover:bg-blue-900 py-2 rounded-lg text-lg' type="submit" >
                            Login
                        </button>
